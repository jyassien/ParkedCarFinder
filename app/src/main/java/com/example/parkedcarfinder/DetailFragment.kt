...
////        updateText(locationViewModel.location.toString())
////    }
////    @SuppressLint("StringFormatMatches")
////    private fun updateText(location: String) {
////        view?.findViewById<TextView>(R.id.activity_fragment_split_detail)?.text = getString(R.string.parking_location, location)
////
////    }
////}
//
